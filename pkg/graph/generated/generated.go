...
func (ec *executionContext) field_Mutation_createEvent_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		...
		arg0, err = ec.unmarshalNNewEvent2githubᚗcomᚋandrioidᚋgostackᚑgqlᚋpkgᚋgraphᚋmodelᚐNewEvent(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) _Mutation_createEvent(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNEvent2ᚖgithubᚗcomᚋandrioidᚋgostackᚑgqlᚋpkgᚋgraphᚋmodelᚐEvent(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_events(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*model.Event)
	fc.Result = res
	return ec.marshalNEvent2ᚕᚖgithubᚗcomᚋandrioidᚋgostackᚑgqlᚋpkgᚋgraphᚋmodelᚐEventᚄ(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNEvent2githubᚗcomᚋandrioidᚋgostackᚑgqlᚋpkgᚋgraphᚋmodelᚐEvent(ctx context.Context, sel ast.SelectionSet, v model.Event) graphql.Marshaler {
	return ec._Event(ctx, sel, &v)
}

func (ec *executionContext) marshalNEvent2ᚕᚖgithubᚗcomᚋandrioidᚋgostackᚑgqlᚋpkgᚋgraphᚋmodelᚐEventᚄ(ctx context.Context, sel ast.SelectionSet, v []*model.Event) graphql.Marshaler {
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalNEvent2ᚖgithubᚗcomᚋandrioidᚋgostackᚑgqlᚋpkgᚋgraphᚋmodelᚐEvent(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalNEvent2ᚖgithubᚗcomᚋandrioidᚋgostackᚑgqlᚋpkgᚋgraphᚋmodelᚐEvent(ctx context.Context, sel ast.SelectionSet, v *model.Event) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "the requested element is null which the schema does not allow")
		}
...
func (ec *executionContext) unmarshalNNewEvent2githubᚗcomᚋandrioidᚋgostackᚑgqlᚋpkgᚋgraphᚋmodelᚐNewEvent(ctx context.Context, v interface{}) (model.NewEvent, error) {
